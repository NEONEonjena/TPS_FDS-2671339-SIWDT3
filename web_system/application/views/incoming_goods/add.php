        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-4">
                        <input value="<?= set_value('arrival_date', date('Y-m-d')); ?>" name="arrival_date"
                            id="arrival_date" type="text" class="form-control date" placeholder="Fecha...">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <select name="id_supplier" id="id_supplier" class="custom-select">
                                ...
                                <option <?= set_select('id_supplier', $s['id_supplier']) ?>
                                    value="<?= $s['id_supplier'] ?>"><?= $s['supplier_name'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                                <a class="btn btn-primary" href="<?= base_url('supplier/add'); ?>"><i
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <select name="id_item" id="id_item" class="custom-select">
                                ...
                                <option <?= $this->uri->segment(3) == $b['id_item'] ? 'selected' : '';  ?>
                                    <?= set_select('id_item', $b['id_item']) ?> value="<?= $b['id_item'] ?>">
                                    <?= $b['id_item'] . ' | ' . $b['name_item'] ?></option>
                                <?php endforeach; ?>
                            </select>
                            <div class="input-group-append">
                                <a class="btn btn-primary" href="<?= base_url('products/add'); ?>"><i
                                        class="fa fa-plus"></i></a>
                            </div>
                        </div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('quantity_in'); ?>" name="quantity_in" id="quantity_in"
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="total_stock">Inventario Total</label>
                    <div class="col-md-5">
